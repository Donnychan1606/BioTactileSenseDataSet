...
print(diff_matrix)
stacked_biases_LSTM = diff_matrix

np.savez('stacked_biases_LSTM.npz', *stacked_biases_LSTM)

# diff_matrix = mapped_matrix - scaled_final_array

for i in range(24):
    plt.plot(stacked_biases_LSTM[:, i], label=f'Channel {i+1}')
